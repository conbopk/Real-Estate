import {View, Text, Image, SafeAreaView, ActivityIndicator, TouchableOpacity, FlatList} from 'react-native'
                    ...
                    <View className='px-5 '>
                        ...
                        <View className='mt-5'>
                            ...
                            <Text className='text-xl font-rubik-bold text-black-300 mt-5'>
                                Found {properties?.length} {params.filter === "All" ? "Properties" : params.filter}
                            </Text>
                        </View>
