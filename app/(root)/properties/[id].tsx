    ...
    return (
        <View>
            <ScrollView
                ...
                contentContainerClassName='pb-32 bg-accent-100'
            >
                <View className='relative w-full' style={{ height: windowHeight/2 }}>
                    ...
                    <View className='z-50 absolute inset-x-7' style={{ top: Platform.OS === "ios" ? 70 : 20, }}>
                        <View className='flex flex-row items-center w-full justify-between mt-12'>
                            <TouchableOpacity
                                onPress={() => router.back()}
            ...
            <View className='absolute bg-accent-100 bottom-0 w-full rounded-t-2xl border-t border-r border-l border-primary-200 p-7'>
                <View className='flex flex-row items-center justify-between gap-10 mb-2'>
